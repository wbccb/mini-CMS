<template>
  <TableBaseView>
    ...
    <template v-slot:other>
      <CreateRole v-model="openDialog" @close-dialog="openDialog = false" :updateItem="currentItem"></CreateRole>
    </template>
  </TableBaseView>
</template>
...
import {networkDeleteMenu, NetworkMenu} from "@/common/api/system/menu";
